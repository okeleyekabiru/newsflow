...
{
    /// <inheritdoc />
    public partial class Initial_WithIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "FlagRuleConfigs",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    Category = table.Column<string>(type: "text", nullable: false),
                    DefaultDecision = table.Column<string>(type: "text", nullable: false),
                    TrustedSources = table.Column<string[]>(type: "text[]", nullable: false),
                    BlockedKeywords = table.Column<string[]>(type: "text[]", nullable: false),
                    ...
                    AutoPostTrustedSources = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlagRuleConfigs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlaggedPosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FlaggedPosts_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    FlaggedPostId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlagAuditLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FlagAuditLogs_FlaggedPosts_FlaggedPostId",
                        column: x => x.FlaggedPostId,
                        principalTable: "FlaggedPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Revenue = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlagAuditLogs_FlaggedPostId",
                table: "FlagAuditLogs",
                column: "FlaggedPostId");

            migrationBuilder.CreateIndex(
                name: "IX_FlaggedPosts_ArticleId",
                table: "FlaggedPosts",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_FlagRuleConfigs_UserId_Category",
                table: "FlagRuleConfigs",
